...
describe('Product API', () => {
  ...
  it('lets admins create products, validates taxonomy, and blocks customers', async () => {
    ...
    const payload = { name: 'Pixel 9 Pro', brandId: google.id, categoryId: phones.id, price: 23990000, stock: 10 };
    ...
    expect(created.body.data).toEqual(expect.objectContaining({ name: 'Pixel 9 Pro', brand: 'Google', category: 'Dien thoai' }));
